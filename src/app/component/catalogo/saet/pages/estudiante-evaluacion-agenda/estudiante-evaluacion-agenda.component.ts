...
export class EstudianteEvaluacionAgendaComponent extends QuestionsComponent implements IMessageComponent {
  ...
  constructor(
    ...
    this.catalogoServiceCOR.getTipoDeEvaluacion(this.nie,TIPO_EVALUACION.psicologo_agenda).then((response) => {
